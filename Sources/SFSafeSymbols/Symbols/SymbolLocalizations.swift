...
public struct Ar_v2_1: SymbolLocalization {
    let source: SFSymbol
    public init(source: SFSymbol) { self.source = source }
    @available(visionOS 1.0, iOS 14.2, macOS 11.0, tvOS 14.2, watchOS 7.1, *)
    public var ar: SFSymbol { .init(rawValue: "\(source.rawValue).\(Localization.ar.rawValue)") }
}
...
public struct Ar_v3: SymbolLocalization {
    let source: SFSymbol
    public init(source: SFSymbol) { self.source = source }
    @available(visionOS 1.0, iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    public var ar: SFSymbol { .init(rawValue: "\(source.rawValue).\(Localization.ar.rawValue)") }
}
...
public struct Ar_v4_1: SymbolLocalization {
    let source: SFSymbol
    public init(source: SFSymbol) { self.source = source }
    @available(visionOS 1.0, iOS 16.1, macOS 13.0, tvOS 16.1, watchOS 9.1, *)
    public var ar: SFSymbol { .init(rawValue: "\(source.rawValue).\(Localization.ar.rawValue)") }
}
